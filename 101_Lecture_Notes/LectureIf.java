...
class LectureIf{
    public static void main(String args[]) {
        ...
        if(answers == 1)
        {
            ...
            {
                System.out.println("Incorrect. Joe hate you forever. ");
            }
        ...
        else if (answers == 3)
        {
            ...
            System.out.println("Pop Quiz: What is Barney's favoritre color?");
            sc.nextLine();
            String answers3 = sc.nextLine();
            if(answers3 == "purple")
            {
                System.out.println("Correct! Barney loves your forever. ");
            }
            else
            {
                System.out.println("Incorrect. Barney hates your forever. ");
            }
        }
        else
        {
